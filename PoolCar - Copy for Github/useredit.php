<?php
    ...
    { 
        ...
        if(empty($email) || empty($name) || empty($tel) || empty($dept) || empty($date) || empty($start_event) || empty($end_event) || empty($no_days) || empty($dest) || empty($placename) || empty($purpose) || empty($title))
        {
            if(empty($email)) {
        ...
        <form action="useredit.php" method="post" name="form1">
            <div class="container">
                <div id="calendar">
                    <div class="row">
                        <div class="col">
                            <input style="background: red; color: white;" type="button" value="Back" onclick="window.location.href='userpage.php'" />
                        </div>
                        <div class="col">
